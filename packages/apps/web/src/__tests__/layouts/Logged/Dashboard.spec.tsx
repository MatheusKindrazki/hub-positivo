...
describe('Logged`s layout should render without crashing', () => {
  ...
  it('Steps should work properly on Dashboard when `open` and `viewed` are true', () => {
  ...
  it('Steps should work properly on Dashboard when `open` is true and `viewed` is false', () => {
  ...
  it('should return user at goBack button', () => {
    jest.useFakeTimers()
